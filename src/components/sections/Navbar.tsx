...
import { Sun, Moon, Menu, X, ChevronRight, Sparkles, ShoppingBag, Hand, Crown, Clock, Bot } from 'lucide-react';
...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { label: 'Products', id: 'auspicious-actions', icon: ShoppingBag, color: 'text-purple-400', borderColor: 'border-purple-400/40', bgIcon: 'bg-purple-400/5' },
    ...
    { label: 'Panchang', id: 'daily-panchang', icon: Clock, color: 'text-amber-400', borderColor: 'border-amber-400/40', bgIcon: 'bg-amber-400/5' },
    { label: 'AI Insights', id: 'ai-reports', icon: Bot, color: 'text-purple-400', borderColor: 'border-purple-400/40', bgIcon: 'bg-purple-400/5' },
  ];
