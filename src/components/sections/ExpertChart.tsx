...
import expert_consultation_img from '../../assets/expert_consultation_img.png'
import nadi_astrology_img from '../../assets/nadi_astrology_img_v3.png'
import personal_reports_img from '../../assets/personal_reports_img.png'

const EXPERTS = [
  {
    badgeText: "Consultation",
    title: "Live Consultations",
    desc: "Speak face-to-face with a senior Vedic scholar. Gain immediate clarity on your career and relationships, and receive powerful planetary remedies.",
    cta: "Book Consultation",
    image: expert_consultation_img,
    titleColor: "text-purple-700 dark:text-purple-400"
  },
  {
    badgeText: "Nadi Reading",
    title: "Nadi Astrology Reading",
    desc: "Discover your destiny through the ancient Nadi system. Reveal past karma and receive powerful remedies for a better future.",
    cta: "Unlock Destiny",
    image: nadi_astrology_img,
    titleColor: "text-purple-600 dark:text-amber-400"
  },
  {
    badgeText: "Written Report",
    title: "Personal Reports",
    desc: "Get comprehensive written reports on your career, marriage, and wealth. Understand the planetary periods shaping your future.",
    cta: "See reports",
    image: personal_reports_img,
          ...
          {EXPERTS.map((item, idx) => (
            ...
            >
              ...
              <div className="relative lg:absolute inset-0 z-0 h-[160px] sm:h-[180px] lg:h-full shrink-0">
                ...
                />
                {/* Very subtle bottom gradient for text readability, keeping the image bright */}
                <div className="hidden lg:block absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent group-hover:from-black/70 transition-all duration-500 opacity-90" />
              </div>

              {/* Content Container: Below image on mobile, over image on desktop */}
              <div className="relative z-10 p-5 sm:p-8 flex flex-col justify-start lg:justify-end h-[280px] sm:h-[280px] lg:h-full bg-white dark:bg-[#0a0e17] lg:bg-transparent lg:dark:bg-transparent">
                <div className="lg:translate-y-4 lg:group-hover:translate-y-0 transition-transform duration-500 ease-out flex flex-col h-full lg:h-auto">
                  {/* Badge */}
                  ...
                  {/* Title */}
                  <h3 className={`font-sans text-xl sm:text-2xl lg:text-3xl ${item.titleColor} lg:text-white lg:dark:text-white group-hover:text-amber-400 lg:group-hover:text-amber-400 dark:group-hover:text-amber-400 font-medium leading-tight mb-2 lg:mb-4 lg:drop-shadow-md transition-colors lg:min-h-[72px]`}>
                    {item.title}
                  </h3>
                  ...
                  {/* CTA */}
                  <div className="inline-flex items-center gap-2 text-amber-300 dark:text-amber-400 font-sans text-[10px] uppercase tracking-widest font-bold group-hover:text-amber-400 dark:group-hover:text-amber-300 transition-colors mt-auto pt-2 lg:pt-0 lg:mb-5">
