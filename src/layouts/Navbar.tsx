...
const DESKTOP_NAV_LINK_STYLES = "relative flex items-center gap-1 px-1 lg:px-1.5 xl:px-2 py-1.5 text-midnight/80 dark:text-cream/90 hover:text-amber-600 dark:hover:text-amber-400 transition-colors font-sans uppercase tracking-[0.05em] xl:tracking-widest text-[8px] lg:text-[9px] xl:text-[10px] font-semibold group whitespace-nowrap";
  ...
  return (
    <header className={HEADER_STYLES}>
      <div className="w-full max-w-[1600px] mx-auto flex items-center justify-between px-4 lg:px-6 py-3">
        ...
        {/* --- Desktop Navigation --- */}
        <nav className="hidden lg:flex flex-1 justify-center items-center gap-0 lg:gap-1 xl:gap-4 text-sm font-medium px-1 xl:px-2">
